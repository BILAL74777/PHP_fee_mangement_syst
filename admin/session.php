                        ...
                        <form class="new-added-form" action="model/insert_Data.php" method="post">
                            <div class="row">
                                 <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Select Fall / Spring *</label>
                                     <select name="from_date" id="" class="form-control">
                                         <option value="Spring">Spring</option>
                                         <option value="Fall">Fall</option>
                                         <option selected="" hidden=""  value="<?php echo $selectedBatch;?>"><?php echo $selectedBatch;?></option>
                                     </select>
                                </div>
                                 <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Year *</label>
                                    <input type="number" name="to_date" value="<?php  echo $end;?>" class="form-control" placeholder="To Year">
                                </div>
                                ...
                                <div class="col-12 form-group mg-t-8">
                                    <input type="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark" value="Save" name="session_save"> 
